...
// UsefulScraps - Gain 8-16 Supplies
func UsefulScraps(game *types.Game, gameID string, invokeTime int64, username string) (*types.Game, error) {
	...
	// Roll for supplies gain (8-16)
	suppliesGain := dice.RollRange(prng, 8, 16)
