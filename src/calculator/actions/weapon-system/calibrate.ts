...
interface WeaponSystemCalibrateParams
  extends Pick<
    GenericCalculatorParams,
...
export default function ({
  ...
  characterID,
  gameID,
}: WeaponSystemCalibrateParams): DefaultCalculatorReturnType {
  ...
  stateCopy.ship.modifiers.set('ship.persistent.weapon.optimized', {
    start: targetStart,
    expiry: targetExpiry,
    amount: 1,
  })
  ...
  character!.cycleActions.set(invokeTime, 'action.weapon-system.calibrate')
  character!.ap -= apUsed
